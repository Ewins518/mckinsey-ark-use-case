...
MVP Demo for ARK Company Finder Agent
"""
...
def main():
    ...
    project_description = st.text_area(
        "Project Description",
        placeholder="""Example: I need to build a commercial office building project. The project includes:
        
- 5-story office building (50,000 sq ft)
...
The project timeline is 18-24 months with a budget of $15M-$20M. We need a construction company that has experience with commercial office buildings, modern construction techniques, and can deliver on time and within budget.
...
Please find the top 5 companies that would be best suited for this project.""",
    ...
    with col1:
        if submit_button and project_description:
            ...
            # Prepare project data - much simpler now
            project_data = {
